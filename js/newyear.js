function newYear() {
    var navidad2021 = new Date('Jan 1, 2022 00:00:00').getTime();
    var navidad2022 = new Date('Jan 1, 2023 00:00:00').getTime();
    var navidad2023 = new Date('Jan 1, 2024 00:00:00').getTime();
