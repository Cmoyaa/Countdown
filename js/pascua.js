function newYear() {
    var navidad2021 = new Date('Apr 17, 2022 00:00:00').getTime();
    var navidad2022 = new Date('Apr 9, 2023 00:00:00').getTime();
    var navidad2023 = new Date('Mar 31, 2024 00:00:00').getTime();
